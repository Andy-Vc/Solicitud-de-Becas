...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const validarUsuarios = [
        ...
        { username: "I202101234", password: "contrasena4", name: "Gabriela Lucia", lastname: "Fuentes Huaman", number: "936552149",career: "Marketing"},
        { username: "I202001234", password: "contrasena5", name: "Raúl Luis", lastname: "Cardenas Vega", number: "912457896",career: "Diseño Gráfico"},
        { username: "I201901234", password: "contrasena6", name: "Patricio Miguel", lastname: "Quispe Velasquez", number: "912345678",career: "Diseño de Videojuego"}
    ];
//Para validar el inicio de sesion y guardar los daatos para mostrar luego
    button.addEventListener('click', function() {
        ...
        if (usuarioValido) {
            ...
            window.location.href = './becaeconomica.html'; 
        } else {
